...
| T1 | Does the best adaptation capacity change with scarce target-label budget? | Engineering/preregistration and smoke complete; formal run not authorized | Row protocol; fixed nested Random labels; compare zero-shot, affine, condition-Ridge residual, `target_head_only`, `last1_head`, and `current_last2_head`. |
