...
| PV2 | Should a condition-complete predictor replace the legacy contract? | Preregistration only; implementation not started | Pass schema, reachability, normalization, legacy-load, and source-function preflight before any separate formal authorization. |
