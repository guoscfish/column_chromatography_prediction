...
- [x] 完成D46-A bounded 171 member fits；三target seeds输出完全一致（within variance=0、pairwise Spearman=1），但只有3/18 candidate-mean paired test-row bootstrap intervals排除0。结果只供人工可靠性判断。
