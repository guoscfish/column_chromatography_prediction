...
def main():
    ...
    action.add_argument("--prepare", action="store_true"); action.add_argument("--validate", action="store_true"); action.add_argument("--execute-seed", type=int); action.add_argument("--finalize-pre-test", action="store_true"); action.add_argument("--reveal-test-and-report", action="store_true")
