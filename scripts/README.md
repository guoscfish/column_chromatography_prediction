...
All retained `run_*.py` files are **historical / reproduction only**:
...
No retained runner authorizes a new experiment. Use a new output directory under `experiments/reproductions/`; runtime/checkpoints/history/progress are gitignored.
