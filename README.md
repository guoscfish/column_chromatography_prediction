...
|---|---|---|
| Predictor | `UNDER_REDESIGN_AND_REQUALIFICATION` | The legacy implementation is frozen historical evidence; Predictor V2 is an engineering-qualified condition-completion ablation; Clean-QGeoGNN is the next implementation candidate. |
