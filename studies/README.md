...
S1 and A1a are completed and stopped. T1a formal execution is complete with no stable winner. T1b-1 is formal complete with 180/180 Adapter fits and no stable improvement over Head; no intermediate capacity sweet spot was found. T1b-2, A1b, and active transfer remain unauthorized/deferred, while independent transfer validation is preferred next.
