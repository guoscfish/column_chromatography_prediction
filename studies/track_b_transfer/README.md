...
S1 is complete. T1a engineering implementation, preregistration, prepare, smoke, resume-safe formal runner, and frozen formal analysis are complete. The formal T1 run remains blocked by `formal_authorized=false`; Track C active transfer remains deferred.
